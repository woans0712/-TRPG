...
window.ENHANCE_BACKEND_DATA = {
  ...
  game: {
    ...
    levels: [
      ...
      { level: 10, name: "회사 지분 있는 뚜비", success: 18, fail: "crack", destroyChance: 1 },
      { level: 11, name: "출근 안 해도 되는 뚜비", success: 13, fail: "crack", destroyChance: 3 },
      { level: 12, name: "건물 한채 있는 뚜비", success: 9, fail: "crack", destroyChance: 5 },
      { level: 13, name: "회장님이랑 밥먹는 뚜비", success: 6, fail: "crack", destroyChance: 7 },
      { level: 14, name: "회사 사버린 뚜비", success: 3, fail: "crack", destroyChance: 10 },
