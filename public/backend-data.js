...
window.ENHANCE_BACKEND_DATA = {
  ...
  game: {
    ...
    // crack = 2단계 하락
    levels: [
      { level: 0, name: "낡은 심심검", success: 95, fail: "keep", destroyChance: 0 },
      { level: 1, name: "손때 묻은 심심검", success: 90, fail: "keep", destroyChance: 0 },
      { level: 2, name: "살짝 빛나는 심심검", success: 84, fail: "keep", destroyChance: 0 },
      { level: 3, name: "다듬어진 심심검", success: 76, fail: "keep", destroyChance: 0 },
      { level: 4, name: "단단한 심심검", success: 68, fail: "keep", destroyChance: 0 },
      { level: 5, name: "예리한 심심검", success: 58, fail: "downgrade", destroyChance: 0 },
      { level: 6, name: "푸른빛 심심검", success: 49, fail: "downgrade", destroyChance: 0 },
      { level: 7, name: "집념의 심심검", success: 40, fail: "downgrade", destroyChance: 0 },
      { level: 8, name: "균열 품은 심심검", success: 32, fail: "downgrade", destroyChance: 0 },
      { level: 9, name: "불안정한 심심검", success: 25, fail: "downgrade", destroyChance: 0 },
      { level: 10, name: "검은 숨결의 심심검", success: 18, fail: "crack", destroyChance: 6 },
      { level: 11, name: "금이 간 별빛검", success: 13, fail: "crack", destroyChance: 10 },
      { level: 12, name: "붉은 맹세검", success: 9, fail: "crack", destroyChance: 18 },
      { level: 13, name: "심연을 벤 검", success: 6, fail: "crack", destroyChance: 28 },
      { level: 14, name: "파멸 직전의 검", success: 3, fail: "crack", destroyChance: 40 },
      { level: 15, name: "완성된 심심검", success: 0, fail: "keep", destroyChance: 0 },
    ],
