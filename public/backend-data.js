...
window.ENHANCE_BACKEND_DATA = {
  ...
  game: {
    ...
    levels: [
      ...
      { level: 5, name: "법카 처음 받아본 뚜비", success: 52, fail: "downgrade", destroyChance: 0 },
      { level: 6, name: "후배 생긴 뚜비", success: 49, fail: "downgrade", destroyChance: 0 },
      { level: 7, name: "칼퇴 성공한 뚜비", success: 43, fail: "downgrade", destroyChance: 0 },
      { level: 8, name: "실세 뚜비", success: 38, fail: "downgrade", destroyChance: 0 },
      { level: 9, name: "연봉협상 이긴 뚜비", success: 32, fail: "downgrade", destroyChance: 0 },
      { level: 10, name: "회사 지분 있는 뚜비", success: 28, fail: "downgrade", destroyChance: 1 },
      { level: 11, name: "출근 안 해도 되는 뚜비", success: 22, fail: "downgrade", destroyChance: 5 },
      { level: 12, name: "건물 한채 있는 뚜비", success: 30, fail: "crack", destroyChance: 7 },
      { level: 13, name: "회장님이랑 밥먹는 뚜비", success: 25, fail: "crack", destroyChance: 9 },
      { level: 14, name: "회사 사버린 뚜비", success: 20, fail: "crack", destroyChance: 12 },
